...
{	
	...
	if(!isset($_FILES['mFile']))
	{
            ...
            $today = date("Y-m-d");
            $query = mysql_query("INSERT INTO projects VALUES ('', '$FileTitle','{$_POST['descr']}','')")or die(mysql_error());
            die("success");
...
//        $layer->applyFilter(IMG_FILTER_BRIGHTNESS, 9, null, null, null, true);
        ...
        $query = mysql_query("INSERT INTO projects VALUES ('', '$FileTitle','{$_POST['descr']}','{$filename}')")or die(mysql_error());
        die("success");
   }else{
