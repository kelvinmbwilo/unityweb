...
{	
	...
	if(!isset($_FILES['mFile']))
	{
            ...
            $query = mysql_query("UPDATE team SET fname = '$FileTitle',mname = '{$_POST['mname']}',lname = '{$_POST['lname']}',project_title = '{$_POST['ptitle']}',other_title = '{$_POST['descr']}',titl = '{$_POST['titl']}',address = '{$_POST['contacts']}' WHERE id='{$_POST['id']}'")or die(mysql_error());
            die("success");
	}else{
   ...
   if(move_uploaded_file($_FILES['mFile']["tmp_name"], $UploadDirectory . $NewFileName ))
   {
	require_once '../imageworkshop/src/PHPImageWorkshop/ImageWorkshop.php';
        ...
        //connect & insert file record in database
         $query = mysql_query("UPDATE team SET fname = '$FileTitle',mname = '{$_POST['mname']}',lname = '{$_POST['lname']}',projyect_title = '{$_POST['ptitle']}',image = '{$filename}',other_title = '{$_POST['descr']}',titl = '{$_POST['titl']}',address = '{$_POST['contacts']}' WHERE id='{$_POST['id']}'")or die(mysql_error());
         die("success");
   }else{
