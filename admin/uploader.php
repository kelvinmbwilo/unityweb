...
{	
	...
	if(!isset($_FILES['mFile']))
	{
            ...
            $query = mysql_query("INSERT INTO team VALUES ('', '$FileTitle','{$_POST['mname']}','{$_POST['lname']}','{$_POST['ptitle']}','{$_POST['descr']}','','{$_POST['titl']}','{$_POST['contacts']}')")or die(mysql_error());
            die("success");
	}else{
...
//   Rename and save uploded file to destination folder.
   if(move_uploaded_file($_FILES['mFile']["tmp_name"], $UploadDirectory . $NewFileName ))
   {
	require_once '../imageworkshop/src/PHPImageWorkshop/ImageWorkshop.php';
        ...
        $query = mysql_query("INSERT INTO team VALUES ('', '$FileTitle','{$_POST['mname']}','{$_POST['lname']}','{$_POST['ptitle']}','{$_POST['descr']}','{$filename}','{$_POST['titl']}','{$_POST['contacts']}')")or die(mysql_error());
        die("success");
   }else{
